...
//        pm.printProductReport(106);
        ...
        pm.printProducts((prod1, prod2) -> prod1.getRating().ordinal() - prod2.getRating().ordinal());
        pm.printProducts((prod1, prod2) -> prod2.getPrice().compareTo(prod1.getPrice()));
        pm.printProducts(Comparator.comparingInt((Product prod) -> prod.getName().length()).reversed());

        Comparator<Product> ratingSorter = (prod1, prod2) ->
                prod2.getRating().ordinal() - prod1.getRating().ordinal();

        Comparator<Product> priceSorter = (prod1, prod2) ->
